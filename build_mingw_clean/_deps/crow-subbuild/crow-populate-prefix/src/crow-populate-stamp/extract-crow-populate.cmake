...
#
get_filename_component(filename "C:/Users/lenovo/Desktop/Supermarket/build_mingw_clean/_deps/crow-subbuild/crow-populate-prefix/src/v1.2.0.zip" ABSOLUTE)
get_filename_component(directory "C:/Users/lenovo/Desktop/Supermarket/build_mingw_clean/_deps/crow-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-crow-populate${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-crow-populate${i}")
